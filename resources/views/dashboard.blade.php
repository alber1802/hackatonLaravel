                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Google ID</p>
                                <p class="font-medium text-xs">{{ $user->google_id }}</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">
                ...
                <div class="p-6">
                            ...
                            @foreach($classroomData['courses'] as $course)
                                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-start justify-between">
                                        <div>
                                            <h4 class="font-medium text-gray-900">{{ $course['name'] ?? 'Clase sin nombre' }}</h4>
                                            <p class="text-sm text-gray-600">{{ $course['section'] ?? '' }}</p>
                                            <p class="text-xs text-gray-500 mt-1">
                                                Estado: <span class="font-medium">{{ $course['courseState'] ?? 'Activo' }}</span>
                                            </p>
                                        </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500">No se encontraron clases</p>
                            <p class="text-sm text-gray-400 mt-1">Puede que necesites permisos adicionales para acceder a Classroom</p>
                        </div>
                    @endif
                </div>
            </div>
